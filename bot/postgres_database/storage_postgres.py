...
class StoragePostgres(Storage):
    ...
    async def persistUpdate(self, update: dict) -> None:
        method_name = "persistUpdate"
    ...
    async def update_user_order(self, telegram_id: int, order_json: dict) -> None:
    ...
    async def clear_user_history(self, telegram_id: int) -> None:
        method_name = "clear_user_history"
        sql_query = (
